...
module.exports = raven = async (client, m, chatUpdate, store) => {
  try {
    ...
    console.log(prefix);
    var body = m.mtype === "conversation" ? m.message.conversation : m.mtype == "extendedTextMessage" ? m.message.extendedTextMessage.text : m.mtype == "buttonsResponseMessage" ? m.message.buttonsResponseMessage.selectedButtonId : m.mtype == "listResponseMessage" ? m.message.listResponseMessage.singleSelectReply.selectedRowId : m.mtype == "templateButtonReplyMessage" ? m.message.templateButtonReplyMessage.selectedId : m.mtype === "messageContextInfo" ? m.message.buttonsResponseMessage?.selectedButtonId || m.message.listResponseMessage?.singleSelectReply.selectedRowId || m.text : "";
    ...
    const participants = m.isGroup && groupMetadata ? groupMetadata.participants.filter(p => p.pn).map(p => p.pn) : [];
    const groupAdmin = m.isGroup ? groupMetadata.participants.filter(p => p.admin && p.pn).map(p => p.pn) : [];
    const isBotAdmin = m.isGroup ? groupAdmin.includes(botNumber) : false;
    const groupSender = m.isGroup && groupMetadata ? (() => {
      const found = groupMetadata.participants.find(p => p.id === sender || client.decodeJid(p.id) === client.decodeJid(sender));
            ...
            await client.sendMessage(client.user.id, {
              ...
              contextInfo: {
                externalAdReply: {
                  ...
                  body: `𝗗𝗘𝗟𝗘𝗧𝗘𝗗 𝗕𝗬: ${`@${deletedBy.split('@')[0]}`}`,
    ...
    if (antibot === "on" && mek.key.id.startsWith("BAE5") && m.isGroup && !isAdmin && isBotAdmin && mek.key.id.length === 16) {
      ...
      client.sendMessage(m.chat, {
        'text': "ᴘᴇᴀᴄᴇ ʜᴜʙ antibot:\n\n@" + kidts.split('@')[0] + " has been identified as a bot. Removed by PEACE to prevent unnecessary spam!",
        'contextInfo': {
          'mentionedJid': [kidts]
        }
      }, {
    ...
    if (gptdm === 'on' && m.chat.endsWith("@s.whatsapp.net")) {
      ...
      try {
        ...
        if (currentTime - lastTextTime < 3000) {
    ...
    //========================================================================================================================//
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕 ]")), chalk.keyword("turquoise")(argsLog), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
╚══════════════════════╝`,
              contextInfo: {
                externalAdReply: {
                  ...
                  sourceUrl: 'https://wa.me/254752818245?text=Hello+Peace+dev+I+need+a+bot',
                  mediaType: 1,
        ...
        case "antilink":
          {
            ...
            if (!text) {
              return reply(`🛡️ Antilink is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: antilink on/off");
            }
            if (text === current) {
              return reply(`✅ Antilink is already *${text.toUpperCase()}*`);
            }
        ...
        case "antilinkall":
          {
            ...
            if (!text) {
              return reply(`🛡️ Antilinkall is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: antilinkall on/off");
            }
            if (text === current) {
              return reply(`✅ Antilinkall is already *${text.toUpperCase()}*`);
            }
        ...
        case "antidelete":
          {
            ...
            if (!text) {
              return reply(`😊 Antidelete is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
        ...
        case "gptdm":
          {
            ...
            if (!text) {
              return reply(`🙂‍↕️ gptdm is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: gptdm on/off");
            }
            if (text === current) {
              return reply(`✅ Gptdm is already *${text.toUpperCase()}*`);
            }
        ...
        case "autoread":
          {
            ...
            if (!text) {
              return reply(`📨 Autoread is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: autoread on/off");
            }
            if (text === current) {
              return reply(`✅ Autoread is already *${text.toUpperCase()}*`);
            }
        ...
        case "mode":
          {
            ...
            if (!text) {
              return reply(`👥️ Mode is currently *${current.toUpperCase()}*`);
            }
            if (!["public", "private"].includes(text)) {
              return reply("Usage: mode public/private");
            }
            if (text === current) {
              return reply(`✅ Mode is already *${text.toUpperCase()}*`);
            }
        ...
        case "autolike":
          {
            ...
            if (!text) {
              return reply(`🫠 Autolike is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: autolike on/off");
            }
            if (text === current) {
              return reply(`✅ Autolike is already *${text.toUpperCase()}*`);
            }
        ...
        case "autobio":
          {
            ...
            if (!text) {
              return reply(`😇 Autobio is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: autobio on/off");
            }
            if (text === current) {
              return reply(`✅ Autobio is already *${text.toUpperCase()}*`);
            }
        ...
        case "autoview":
          {
            ...
            if (!text) {
              return reply(`👀 Auto view status is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: autoview on/off");
            }
            if (text === current) {
              return reply(`✅ Auto view status is already *${text.toUpperCase()}*`);
            }
        ...
        case "wapresence":
          {
            ...
            if (!text) {
              return reply(`👤 Presence is currently *${current}*`);
            }
            if (!["typing", "online", "recording"].includes(text)) {
              return reply("Usage: wapresence typing/online/recording");
            }
            if (text === current) {
        ...
        case "badword":
          {
            ...
            if (!text) {
              return reply(`😈 Badword is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: badword on/off");
            }
            if (text === current) {
              return reply(`✅ Badword is already *${text.toUpperCase()}*`);
            }
        ...
        case "anticall":
          {
            ...
            if (!text) {
              return reply(`🔰 Anticall is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: Anticall on/off");
            }
            if (text === current) {
              return reply(`✅ Anticall is already *${text.toUpperCase()}*`);
            }
        ...
        case "antibot":
          {
            ...
            if (!text) {
              return reply(`👾 Antibot is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: antibot on/off");
            }
            if (text === current) {
              return reply(`✅ Antibot is already *${text.toUpperCase()}*`);
            }
        ...
        case "antitag":
          {
            ...
            if (!text) {
              return reply(`🤖 Antitag is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: antitag on/off");
            }
            if (text === current) {
              return reply(`✅ Antitag is already *${text.toUpperCase()}*`);
            }
        ...
        case "welcomegoodbye":
          {
            ...
            if (!text) {
              return reply(`🕳 Welcomegoodbye is currently *${current.toUpperCase()}*`);
            }
            if (!["on", "off"].includes(text)) {
              return reply("Usage: welcomegoodbye on/off");
            }
            if (text === current) {
              return reply(`✅ Welcomegoodbye is already *${text.toUpperCase()}*`);
            }
        ...
        case "getcase":
          {
            if (!Owner) {
              return reply('Only owner');
            }
            if (!text) {
              return reply("Example usage:- getcase menu");
            }
            try {
              reply(`${"case " + `\"${q}\"` + fs.readFileSync('./action/raven.js').toString().split("case \"" + q + "\"")[1].split("break")[0] + "break"}`);
            } catch (e) {
        ...
        case "bible":
          {
            ...
            try {
              ...
              if (response.status === 200 && response.data.text) {
                ...
                reply(`*Hello there, below is what you requested*\n\n` + `📖 *Reference:* ${ref}\n` + ` ${text}\n\n` + `_Requested by ${pushname}_`);
              } else {
        ...
        case "rent":
          {
            if (!q) {
              return await reply("Please provide valid Whatsapp number  Example- pair 254752818XXX");
            }
            try {
              ...
              for (const number of numbers) {
                ...
                let {
                  data
                } = await axios(`https://peacehub-pair.onrender.com/code?number=${number}`);
                let code = data.code;
                await sleep(3000);
                await m.reply(`${code}`);
              }
        ...
        case "song2":
          {
            if (!text) {
              m.reply("What song you want to download.");
            }
            try {
        ...
        case "song":
          {
            ...
            try {
              ...
              const response = await axios.get(`${'https://noobs-api.top'}/dipto/ytDl3?link=${encodeURIComponent(video.videoId)}&format=mp3`);
        ...
        case "video":
          {
            ...
            try {
              ...
              m.reply("_Please wait your download is in progress_");
              const safeTitle = video.title.replace(/[\\/:*?"<>|]/g, '');
              const response = await axios.get(`${'https://noobs-api.top'}/dipto/ytDl3?link=${encodeURIComponent(video.videoId)}&format=mp4`);
              const data = response.data;
              if (!data.downloadLink) {
                return client.sendMessage(from, {
        ...
        case 'video2':
          {
            if (!text) {
              reply("What video you want to download?");
            }
            try {
              let search = await yts(text);
              if (!search.all.length) {
        ...
        case "redeploy":
          {
            ...
            async function redeployApp() {
              try {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *PEACE-HUB* unleashed upon you.");
        ...
        case 'metallic':
          {
            if (!text || text == "") {
              m.reply("Example Usage : " + prefix + "Metallic Peace");
              return;
            }
            try {
              ...
              await client.sendMessage(m.chat, {
                ...
                caption: `GENERATED BY PEACE-HUB`
              });
            } catch (_0x180d0734) {
              m.reply(_0x180d0734);
            }
        ...
        case 'typography':
          {
            if (!text || text == "") {
              m.reply("Example Usage : " + prefix + "Typography Peace");
              return;
            }
            try {
        ...
        case 'purple':
          {
            if (!text || text == "") {
              m.reply("Example Usage : " + prefix + "purple Peace");
              return;
            }
            try {
        ...
        case 'leaves':
          {
            if (!text || text == "") {
              m.reply("Example Usage : " + prefix + "Leaves PEACE-HUB");
              return;
            }
            try {
        ...
        case 'hacker':
          {
            if (!text || text == "") {
              m.reply("Example usage :  " + prefix + "hacker Peace");
              return;
            }
            try {
        ...
        case 'sand':
          {
            if (!text || text == "") {
              m.reply("Example Usage : " + prefix + "sand Peace");
              return;
            }
            try {
        ...
        case 'dragonball':
          {
            if (!text || text == "") {
              m.reply("Example usage :  " + prefix + "dragonball Peace");
              return;
            }
            try {
        ...
        case 'cat':
          {
            if (!text || text == "") {
              m.reply("Example usage : * " + prefix + "cat Peace");
              return;
            }
            try {
        ...
        case 'child':
          {
            if (!text || text == "") {
              m.reply("Example usage: " + prefix + "Child Peace");
              return;
            }
            try {
        ...
        case 'genpassword':
          {
            try {
              ...
              const generatePassword = len => {
                let password = '';
                for (let i = 0; i < len; i++) {
                  const randomIndex = crypto.randomInt(0, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^&*()_+[]{}|;:,.<>?'.length);
                  password += 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^&*()_+[]{}|;:,.<>?'[randomIndex];
                }
                return password;
              };
...
`);
        ...
        case 'rship':
          {
            try {
              ...
              await client.sendMessage(from, {
                text: `${'@' + sender.split('@')[0]} your match is  ${'@' + randomParticipant.split('@')[0]}\nCongratulations☠️`,
        ...
        case 'gpt3':
          {
            if (!q) {
              return reply("Holla, I'm listening to you..");
            }
            try {
              const {
                data
              } = await axios.get(`https://vapis.my.id/api/openai?q=${encodeURIComponent(q)}`);
              if (!data || !data.result) {
        ...
        case "gpt2":
          {
            ...
            try {
              const {
                data
              } = await axios.get(`https://lance-frank-asta.onrender.com/api/gpt?q=${encodeURIComponent(q)}`);
        ...
        case 'gpt':
          {
            if (!text) {
              return m.reply("Hello there, what's going on ?");
            }
            try {
        ...
        case 'translate':
          {
            try {
              ...
              const translation = await translatte(quotedMessage, {
                to: langCode
              });
        ...
        case 'createimage':
          {
            if (!text) {
              return m.reply("What image do you want to create ?");
            }
            m.reply('*Please wait i am generating your image...*');
            try {
              const data = await fetchJson(`https://api.dreaded.site/api/imagine?text=${encodeURIComponent(text)}`);
              if (!data.status || !data.result) {
        ...
        case "ai":
          {
            ...
            try {
              ...
              if (!text) {
                return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              }
        ...
        case "ai2":
          {
            try {
              ...
              if (!text) {
                return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝙋𝙀𝘼𝘾𝙀  AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              }
              if (!/image|pdf/.test(mime)) {
              ...
              m.reply(`𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗣𝗘𝗔𝗖𝗘[𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 ${mime.includes("pdf") ? "𝗣𝗗𝗙" : "𝗜𝗺𝗮𝗴𝗲"} . . .`);
        ...
        case "vision":
          {
            if (!msgR || !text) {
              m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              return;
            }
            ;
            let _0x44b3e0;
        ...
        case 'remini':
          {
            ...
            client.sendMessage(m.chat, {
              image: proses,
              caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕'
            }, {
              quoted: m
            });
          }
        ...
        case "kickall":
          {
            ...
            await client.groupUpdateDescription(m.chat, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝙋𝙀𝘼𝘾𝙀 𝗗𝗲𝘃 !");
        ...
        case "kickall2":
          {
            ...
            try {
              ...
              await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝙋𝙀𝘼𝘾𝙀 𝗗𝗲𝘃 !");
...
🌅 Sunset: ${sunset.toLocaleTimeString()}`);
        ...
        case "add":
          {
            ...
            if (!q || isNaN(q)) {
              return m.reply("provide number to be added in this format.\n\nadd 254114660061");
            }
            try {
              // Format the phone number
              // Add the user to the group
              await client.groupParticipantsUpdate(m.chat, [`${q}@s.whatsapp.net`], "add");
        ...
        case "system":
          client.sendMessage(m.chat, {
            ...
            caption: `*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝗣𝗲𝗮𝗰𝗲 *\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝗣𝗘𝗔𝗖𝗘𝗠𝗔𝗞𝗘𝗥༆`
          });
          break;
        ...
        case "faker":
          {
            ...
            if (!args || !args[0]) {
              ...
              let _0x2d7d67 = `𝙿𝚎𝚊𝚌𝚎 𝚑𝚊𝚜 𝚍𝚎𝚝𝚎𝚌𝚝𝚎𝚍 𝚝𝚑𝚎 𝚏𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝚊𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚒𝚗 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙:- \n`;
              for (let _0x28761c of _0x2f8982) {
              ...
              setTimeout(() => {
                client.sendMessage(m.chat, {
                  text: `𝙽𝚘𝚠 𝙿𝚎𝚊𝚌𝚎 𝚠𝚒𝚕𝚕 𝚛𝚎𝚖𝚘𝚟𝚎 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝙰𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚏𝚛𝚘𝚖 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙.\n\n𝙶𝚘𝚘𝚍𝚋𝚢𝚎👋 𝙵𝚊𝚔𝚎 𝚙𝚎𝚘𝚙𝚕𝚎.`
                }, {
                  quoted: m
                });
                setTimeout(() => {
        ...
        case "getvar":
          ...
          let stoy = "*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗣𝗘𝗔𝗖𝗘 𝗛𝗨𝗕:*\n\n";
          for (vrt in h9) {
        ...
        case "kick":
          {
            ...
            if (users == "254752818245@s.whatsapp.net") {
        ...
        case "pin":
          {
            if (!text) {
              return reply('𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝗮 𝘃𝗮𝗹𝗶𝗱 𝗽𝗶𝗻𝘁𝗲𝗿𝗲𝘀𝘁 𝗹𝗶𝗻𝗸 !');
            }
            ...
            try {
              const response = await axios.get(`https://bk9.fun/download/pinterest?url=${encodeURIComponent(text)}`);
        ...
        case "epl-table":
          {
            try {
              ...
              await m.reply(` 𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗘𝗽𝗹 𝗧𝗮𝗯𝗹𝗲 𝗦𝘁𝗮𝗻𝗱𝗶𝗻𝗴𝘀:-\n\n${standings}`);
            } catch (error) {
        ...
        case "pd-table":
          {
            try {
              ...
              const standings = data.data;
              await m.reply(`𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗟𝗮𝗹𝗶𝗴𝗮 𝗧𝗮𝗯𝗹𝗲 𝗦𝘁𝗮𝗻𝗱𝗶𝗻𝗴𝘀:-\n\n${standings}`);
            } catch (error) {
        ...
        case "bl-table":
          {
            try {
              ...
              const standings = data.data;
              await m.reply(`𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗕𝘂𝗻𝗱𝗲𝘀𝗹𝗶𝗴𝗮 𝗧𝗮𝗯𝗹𝗲 𝗦𝘁𝗮𝗻𝗱𝗶𝗻𝗴𝘀\n\n${standings}`);
            } catch (error) {
        ...
        case "lg-1":
          {
            try {
              ...
              const standings = data.data;
              await m.reply(`𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗟𝗶𝗴𝘂𝗲-1 𝗧𝗮𝗯𝗹𝗲 𝗦𝘁𝗮𝗻𝗱𝗶𝗻𝗴𝘀\n\n${standings}`);
            } catch (error) {
        ...
        case "sa-table":
          {
            try {
              ...
              const standings = data.data;
              await m.reply(`𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗦𝗲𝗿𝗶𝗲-𝗮 𝗧𝗮𝗯𝗹𝗲 𝗦𝘁𝗮𝗻𝗱𝗶𝗻𝗴𝘀\n\n${standings}`);
            } catch (error) {
        ...
        case "retrieve":
          {
            ...
            if (quotedMessage.imageMessage) {
              ...
              client.sendMessage(m.chat, {
                ...
                caption: `🛡️ No secrets here. View once? Not on PEACE HUB!\n${imageCaption}`
              }, {
                quoted: m
              });
            }
                  ...
                  if (data.status === 200 || data.success) {
                    ...
                    ffmpeg(response.data).toFormat("mp3").save(outputPath).on("end", async () => {
                      await client.sendMessage(m.chat, {
                        ...
                        mimetype: "audio/mp3",
                        caption: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ᴘᴇᴀᴄᴇ ʜᴜʙ",
                        fileName: `${search.all[0].title.replace(/[^a-zA-Z0-9 ]/g, "")}.mp3`
                      }, {
                        quoted: m
                      });
          ...
          client.sendMessage(m.chat, {
            ...
            contextInfo: {
              externalAdReply: {
                ...
                thumbnailUrl: 'https://files.catbox.moe/uykxm4.jpg',
                sourceUrl: 'https://github.com/Devpeacemaker/PEACE-HUB',
                mediaType: 1,
                renderLargerThumbnail: true
              }
            }
        ...
        case "photo":
          {
            ...
            exec(`ffmpeg -i ${media} ${mokaya}`, err => {
              ...
              client.sendMessage(m.chat, {
                image: buffer,
                caption: `ᴄᴏɴᴠᴇʀᴛᴇᴅ ʙʏ ᴘᴇᴀᴄᴇ ʜᴜʙ`
              }, {
                quoted: m
              });
        ...
        case "gemini":
          {
            try {
              if (!text) {
                return m.reply("This is Peace, an AI using Gemini APIs to process text, provide yr query");
              }
              const {
                default: Gemini
              } = await import('gemini-ai');
        ...
        case 'gcprofile':
          {
            ...
            try {
              ...
              pp = 'https://files.catbox.moe/uykxm4.jpg';
            }
            await client.sendMessage(m.chat, {
              image: {
                url: pp
        ...
        default:
          {
            if (cmd && budy.toLowerCase() != undefined) {
              ...
              if (argsLog || cmd && !m.isGroup) {
                ...
                console.log(chalk.black(chalk.bgRed("[ ERROR ]")), chalk.keyword("turquoise")("command"), chalk.keyword("turquoise")(`${prefix}${command}`), chalk.keyword("turquoise")("Peace"));
