...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱 𝙰𝙽𝚃𝙸𝙳𝙴𝙻𝙴𝚃𝙴░\n\n` +
      ` 𝙳𝙴𝙻𝙴𝚃𝙴𝙳 𝙱𝚈: ${deletedByFormatted}\n\n`;
...
// Video message
	const VideoM = originalMessage.message.videoMessage;    
        notificationText += ` 𝙳𝙴𝙻𝙴𝚃𝙴𝙳 𝙼𝙴𝙳𝙸𝙰: [Video]`;
        try {
...
// Document message
        notificationText += ` 𝙳𝙴𝙻𝙴𝚃𝙴𝙳 𝙼𝙴𝙳𝙸𝙰: [Document]`;
...
// Audio message     
	...
	notificationText += ` 𝙳𝙴𝙻𝙴𝚃𝙴𝙳 𝙼𝙴𝙳𝙸𝙰: [Audio]`;
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/254752818245?text=Hello+Peacemaker+dev+I+need+a+bot',
                                mediaType: 1,
...
//========================================================================================================================//		
	      case 'matrix':{		      		     
		      if (!text || text == "") {
    m.reply("Example usage: " + prefix + "Matrix Peacemaker");
    return;
  } 
  try {
...
//========================================================================================================================//		
	      case 'light': {		      
		      if (!text || text == "") {
    m.reply("Example usage: " + prefix + "Light peacemaker");
    return;
  } 
  try {
...
//========================================================================================================================//		      
	case 'leaves': {		     
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves Peacemaker");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena Peacemaker");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'naruto': {		      
		      if (!text || text == "") {
      m.reply("Example usage : " + prefix + "naruto Peacemaker");
      return;
    }
    try {
...
//========================================================================================================================//		      
	      case 'graffiti': {		      
		      if (!text || text == "") {
    m.reply("Example usage : " + prefix + "graffiti Peacemaker");
    return;
  }
  try {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝙋𝙀𝘼𝘾𝙀 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
...
if (!text) return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱 AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
if (!/image|pdf/.test(mime)) return m.reply("That is not an image, try again while quoting an actual image.");             
                    ...
                    m.reply(`𝙰 𝙼𝚘𝚖𝚎𝚗𝚝, 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱 [𝙿𝚎𝚊𝚌𝚎-𝙰𝚒] 𝚒𝚜 𝚊𝚗𝚊𝚕𝚢𝚣𝚒𝚗𝚐 𝚝𝚑𝚎 𝚌𝚘𝚗𝚝𝚎𝚗𝚝𝚜 𝚘𝚏 𝚝𝚑𝚎${mime.includes("pdf") ? "𝗣𝗗𝗙" : "𝗜𝗺𝗮𝗴𝗲"} . . .`);
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝚀𝚞𝚘𝚝𝚎 𝚊𝚗 𝚒𝚖𝚊𝚐𝚎 𝚊𝚗𝚍 𝚐𝚒𝚟𝚎 𝚜𝚘𝚖𝚎 𝚒𝚗𝚜𝚝𝚛𝚞𝚌𝚝𝚒𝚘𝚗𝚜 𝚎𝚑. 𝙸'𝚖 𝙿𝚎𝚊𝚌𝚎 𝙰𝚒, 𝚒 𝚞𝚜𝚎 𝙱𝚊𝚛𝚍 𝚝𝚘 𝚊𝚗𝚊𝚕𝚢𝚣𝚎 𝚒𝚖𝚊𝚐𝚎𝚜.");
    return;
  }
  ;
  let _0x44b3e0;
...
case "kill": case "kickall": {
      ...
      await client.groupUpdateDescription(m.chat, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗣𝗘𝗔𝗖𝗘 𝗗𝗲𝘃 !");
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝙱𝚢 𝚝𝚑𝚎 𝚘𝚛𝚍𝚎𝚛 𝚘𝚏 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱!");
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙴𝙳 𝙱𝚈 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱`}, { quoted: m}) 
...
//========================================================================================================================//		      
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "👋 𝙷𝚎𝚕𝚕𝚘, 𝚖𝚘𝚛𝚝𝚊𝚕! ⚡ 𝙿𝚎𝚊𝚌𝚎 𝙷𝚞𝚋 𝚒𝚜 𝚊𝚕𝚒𝚟𝚎!",
          body: "𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱",
          thumbnailUrl: "https://files.catbox.moe/5m0i6t.jpg",
          sourceUrl: '',
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
await client.sendMessage(m.chat, { image: { url: imagelink}, caption: "𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙴𝙳 𝙱𝚈 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱! 🦄"}, { quoted: m});
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗣𝗲𝗮𝗰𝗲-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Retrieved by Peace!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(m.chat, { video: { url: videoUrl }, caption: `Retrieved by Peace!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
if (!m.quoted) return m.reply("Hurrahhh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `Retrieved by Peace!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `Retrieved by Peace!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙴𝙳 𝙱𝚈 𝙿𝙴𝙰𝙲𝙴 𝙷𝚄𝙱}, { quoted: m }) 
...
try {
        ...
        pp = 'https://files.catbox.moe/yusei5.jpg';
      }
